...
// Registering for push and asking for notification permission only makes
// sense once someone is actually signed in — asking (or worse, showing a
// blocking dialog) before that just gets in the way of the login screen.
export default function NotificationPermissionManager() {
  const { appUser } = useAuth();
  const isSignedIn = Boolean(appUser);
